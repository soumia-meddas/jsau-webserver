...
```
cd existing_repo
git remote add origin https://gitlab.sorbonne-paris-nord.fr/11924788/jsau-webserver.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.sorbonne-paris-nord.fr/11924788/jsau-webserver/-/settings/integrations)
